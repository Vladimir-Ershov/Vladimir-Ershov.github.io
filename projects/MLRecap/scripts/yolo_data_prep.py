...
data_absolute = "/home/not7/src/Vladimir-Ershov.github.io/projects/MLRecap/data/"

masks = data_absolute + 'masks/'
create_folder(data_absolute + 'yolov7/train/images')
create_folder(data_absolute + 'yolov7/train/labels')
create_folder(data_absolute + 'yolov7/val/images')
create_folder(data_absolute + 'yolov7/val/labels')
create_folder(data_absolute + 'yolov7/test/images')
create_folder(data_absolute + 'yolov7/test/labels')

#%% get all image files
img_folder = masks + 'images'
_, _, files = next(os.walk(img_folder))
pos = 0
for f in files:
        source_img = os.path.join(img_folder, f)
        if pos < 700:
            dest_folder = data_absolute + 'yolov7/train'
        elif (pos >= 700 and pos < 800):
            dest_folder = data_absolute + 'yolov7/val'
        else:
            dest_folder = data_absolute + 'yolov7/test'
        ...
        label_source_path = os.path.join(masks + 'annotations', label_source_file)
